            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        <!-- Upload/Sell Button -->
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('upload'))); ?>" 
                ...
                <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200">
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <div class="pt-4 border-t border-gray-200 mt-4 space-y-2">
                            <button class="w-full text-left px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-colors" 
                                    onclick="toggleSearch()">
...
class ArtsPlans_Walker_Nav_Menu extends Walker_Nav_Menu {
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        $output .= '<a href="' . esc_url($item->url) . '"' . $class_names . ' class="text-sm font-medium transition-colors hover:text-blue-600 ' . (in_array('current-menu-item', $classes) ? 'text-blue-600' : 'text-gray-700') . '">';
...
class ArtsPlans_Mobile_Walker_Nav_Menu extends Walker_Nav_Menu {
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        $output .= '<a href="' . esc_url($item->url) . '"' . $class_names . ' class="block px-3 py-2 text-base font-medium transition-colors ' . (in_array('current-menu-item', $classes) ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50') . ' rounded-lg">';
        $output .= esc_html($item->title);
        $output .= '</a>';
    }
}
...
function artsplans_fallback_menu() {
    $pages = array(
        ...
        array('title' => __('Categories', 'artsplans'), 'url' => get_term_link('design_category')),
        array('title' => __('3D Models', 'artsplans'), 'url' => get_post_type_archive_link('model_3d')),
        array('title' => __('Courses', 'artsplans'), 'url' => '#'),
        array('title' => __('Sell', 'artsplans'), 'url' => get_permalink(get_page_by_path('upload'))),
    );
